<template>
    <div class="about-self-mobile-container">
        <h1 class="about-self-mobile-title">ДЕНИС ПЕРЕВОЗНИКОВ</h1>

        <div style="margin-bottom: 20px;">
            <img style="width: 222px; height: 306px" src="../../assets/imgs/mainPage/pereDen.jpg" >
        </div>
        <div >
